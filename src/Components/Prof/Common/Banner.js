                        ...
                        <ul className="row p-0 mb-0 mt-2">
                            ...
                            <li className="col-xs-12 col-lg-1 col py-0 my-1 text-center p-0">
                                    ...
                                    overlay={
                                        <Popover id={`popover-positioned-bottom`} className="mt-md-4 mt-sm-3 mt-2 " >
                                            <Popover.Content>
                                                ...
                                                <Link to="Settings"><button type="button" className="w-100 d-block btn btn-outline-white border border-0  text-left buttonOutline" > <i className="fas fa-cog text-secondary text-left"></i> Paramètres </button></Link>
                                                <hr className="mb-0 mt-1 py-0" />
                                                <button type="button" onClick={this.LogoutFunction} className="w-100 d-block btn btn-outline-white border border-0 text-danger text-left buttonOutline"  > <i className="fas fa-sign-out-alt text-danger text-left"></i> Déconnexion </button>
                                ...
                                >
                                    ...
                                    <Button className="bg-transparent p-0 buttonOutline" style={{ outline: '0px !important', border: '#003D7E', boxShadow: 'none !important' }} ><span className="d-block mx-auto mt-n3"> <i className="fas fa-ellipsis-h fa-2x text-light"></i> </span></Button>
                                </OverlayTrigger>
                            </li>
                        </ul>
                    </nav>
