        ...
        for (let i = 0; i < this.state.data.length; i++) {
            ...
            rows.push(
                <tr key={this.state.data[i].id} className="py-3">
                    <th scope="row" className="text-left py-3">{this.state.data[i].ClasseName}</th>
                        ...
                        <div className="row mt-3" style={{ Height: '100%' }}>
                            ...
                            <div className="col-lg-6 col-md-8 no-pd">
                                <div className="main-ws-sec">
                                    ...
                                    <h5 className="text-nowrap h1 mt-md-4 mt-3 text-center"> Mes Classes : </h5>
                                    <div className="table-responsive mt-md-5 mt-3">
                                        <table className="table table-hover">
                                            <thead className="">
                                                <tr className=" bg-info text-light">
                                                    <th scope="col " className="text-left py-4">Classe</th>
                                                    <th scope="col" className=" text-center py-4">Filiere</th>
                                                    <th scope="col" className=" text-center py-4">Année</th>
                                                </tr>
                                            </thead>
                                            <tbody>
