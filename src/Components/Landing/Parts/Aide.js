...
class Aide extends React.Component {
  ...
  render() {
    return (
      <>
        <div
          className="jumbotron jumbotron-fluid  w-100 d-inline-block pb-5 mb-n3"
          style={{ height: "100%" }}
          id="aideContai"
        >
            ...
            >
              {({
                ...
                if (this.state.error === "succeded") {
                  ...
                  return (
                    <Form
                      className="col-md-8 mx-auto mt-5 mb-0 pb-5"
                      methode="GET"
                    >
                      <div className="form-group">
                        ...
                        <small id="emailHelp" className="form-text text-muted">
                          Nous allons jamais le partager avec quelq'un d'autre.
                        </small>
