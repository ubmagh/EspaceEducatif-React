                ...
                <div className="container py-4">
                    <div className="row text-light">
                        ...
                        <div className="col  mx-auto">
                            ...
                            <p className="text-justify text-left text-light" >Un réseau éducatif privé aux étudiants et aux professeurs de l'école supérieure de Technologie Agadir, Afin de faciliter l'accès à l'information.</p>
                        </div>
